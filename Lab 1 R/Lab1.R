...
# To read this dataset we will use the read.csv() function in R
# Use ?read.csv or help(read.csv) to learn more about that function
?read.csv
ni.db <- read.csv(file = "~/Desktop/BIO6400/Python_Labs/Lab 1 R/ni.2789.clinical.csv", stringsAsFactors = FALSE)
